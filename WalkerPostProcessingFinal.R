...
plot_final_graphs <- function(WalkerTemp, NealTemp, SPD, npostsum, calcurve, lambda, nu1, nu2, postden, postdenCI, x, xsig) {
  ...
  lines(tempx, postden, col = walker_colour)
  lines(tempx, postdenCI[1, ], col = walker_colour, lty = 2)
  lines(tempx, postdenCI[2, ], col = walker_colour, lty = 2)
  ...
  plot_number_of_walker_clusters(Temp)
}
